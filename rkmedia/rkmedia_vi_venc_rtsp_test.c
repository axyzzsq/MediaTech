...
int main(int argc, char *argv[]) {
  ...
  {
	/*
	 * 这个 API 用于设置 RTSP 会话的视频编解码器。它接受四个参数：g_rtsp_session 是 RTSP 会话实例，
	 * RTSP_CODEC_ID_VIDEO_H264 是视频编解码器的 ID，NULL 是指向视频编码参数的指针，0 是视频编码参
	 * 数的大小。在这个例子中，视频编解码器的 ID 是 RTSP_CODEC_ID_VIDEO_H264，它指定了 H.264 视频编
	 * 解码器。因此，这个 API 的作用是将 RTSP 会话的视频编解码器设置为 H.264。
	 */
